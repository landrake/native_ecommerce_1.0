            ...
            <div class="col-md-10">
                <table class="table">
                    ...
                    <?php
                        $no = 1;
                        include '../koneksi.php';
                        $sql = "SELECT * FROM ecom_haris.order";
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                $status = $val['status']; 
                                if ($status == '1') {
                                    echo "Sedang di proses, Menunggu Bukti Pembayaran";
                                }
                                if ($status == '2') {
                                    echo "<a class='btn btn-primary' href='proses_kirim_barang.php?id_order=".$val['id_order']."'>Kirim Barang!</a>";
                                }
                                if ($status == '3') {
